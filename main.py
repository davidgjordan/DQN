...
agent = Controller(height=64, width=64, agent_history_length=4, num_filters=[32, 64, 64], filter_shapes=[8, 4, 3],
                   ...
                   mini_batch_size=100, target_update_frequency=scale, display=False, epsilon_initial=1.0,
                   epsilon_final=0.1, annealing_steps=100*scale, discount_factor=0.99, train_steps=5000*scale,
                   gradient_descent_frequency=4, learning_rate=0.00025, momentum=0.0, rms_decay=0.99,
